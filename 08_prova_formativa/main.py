...
class AppPrincipal:
    def __init__(self):
        ...
        self.label_titulo = ttk.Label(self.janela, text="🍉", font=("Helvetica", 90))
        self.label_titulo.place(x=50, y=50)

        self.label_titulo2 = ttk.Label(self.janela, text="🍉", font=("Helvetica", 90))
        self.label_titulo2.place(x=300, y=50)

        self.label_titulo3 = ttk.Label(self.janela, text="🍉", font=("Helvetica", 90))
        self.label_titulo3.place(x=550, y=50)

        self.button_sorteio = ttk.Button(self.janela, text="Sortear", width=15, command=self.sorteio)
        self.button_sorteio.place(x=300, y=300)
